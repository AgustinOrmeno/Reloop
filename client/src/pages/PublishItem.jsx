...
export default function PublishItem() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Publicar:', { ...form, size: selectedSize, condition: selectedCondition })
  }
      ...
      <div className="px-[7%] py-12">
        ...
        <div className="grid grid-cols-3 gap-16">
          ...
          <form onSubmit={handleSubmit} className="col-span-2 flex flex-col gap-8">
            ...
            <button
              type="submit"
              className="w-full bg-terracota hover:bg-terracota-dark text-white text-sm font-medium py-4 rounded transition-colors duration-200"
            >
              Publicar prenda
            </button>
